...
//        }
        ...
        let collectionMessage: [String: Any] = [
            ...
            "type": firstMessage.kind.messasgeKindString,
            "content": message,
            "date": dateString,
        ...
        print("adding conv: \(conversationID)")
    ...
    /// Sneds a message with target conversation and message
    public func sendMessage(to conversation: String, otherUserEmail: String, name: String, newMessage: Message, completion: @escaping (Bool) -> Void) {
        ...
        database.child("\(conversation)/messages").observeSingleEvent(of: .value, with: { [weak self] snapshot in
            ...
            let newMessageEntry: [String: Any] = [
                ...
                "type": newMessage.kind.messasgeKindString,
                "content": message,
                "date": dateString,
                "sender_email": currentUserEmail,
                "is_read": false,
...
struct ChatAppUser {
    ...
    var profilePictureFileName: String {
        //shng93-gmail-com_profile_picture.png
